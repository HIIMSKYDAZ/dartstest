                ...
                <div>
                    ...
                    {chesses.map((chess, index) => (
                        ...
                        <div className="card col-sm-3 d-inline-block m-1 p-2" key={index}>
                            <p className="text-dark">Dartsozó neve: {chess.name}</p>
...
{chess.profile_url.startsWith('http') ? (
                                ...
                                <br />
                                <NavLink key={chess.id} to={"/darts/" + chess.id}>
                                    <img alt={chess.nev}
                                        className="img-fluid"
                                        style={{ maxHeight: 200 }}
                                ...
                                <br />
                                <NavLink key="x" to={"/mod-darts/" + chess.id}>
                                    <i className="bi bi-pencil"></i></NavLink> &nbsp;&nbsp;
                                    <NavLink key="y" to={"/del-darts/" + chess.id}><i className="bi bi-trash3"></i></NavLink>
                            </div>
                        </div>
